      ...
      <div className="px-4 py-4">
        <div className="row text-center">
          <div className="col-lg-4 col-sm-12">
            ...
            <div className="text-start">
              <input type="text" className="form-control mt-2 border-dark" />
            </div>
          </div>
          <div className="col-lg-4 col-sm-12">
        ...
        <div className="d-flex justify-content-end mt-3 ">
          <div className="d-flex gap-2">
            <div className="d-flex gap-1">
              ...
              <input type="text" className="border-normal" />
            </div>
            <div className="d-flex gap-1">
          ...
          <div className="col-lg-5">
            ...
            />
              ...
              <div className="col">
                ...
                <input type="text" className="w-100 border-normal p-1" />
                <div></div>
        ...
        <div className="row mt-4 w-75">
          <div className="col-lg-4 col-sm-12 mt-2">
            <div style={{width:"100%" , border:"2px solid #1B365D" , borderRadius:"10px" , height:"500px" }}></div>
